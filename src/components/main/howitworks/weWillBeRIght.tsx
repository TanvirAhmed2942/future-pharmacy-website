...
function WeWillBeRight() {
  return (
    <section className="bg-gradient-to-br from-purple-50 to-pink-50 py-16 md:py-16 px-4 md:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Text Content */}
          <div className="space-y-6">
            <h2 className="text-4xl md:text-5xl font-bold text-peter font-inter">
