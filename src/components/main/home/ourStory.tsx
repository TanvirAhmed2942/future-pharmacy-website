      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="text-center md:text-left relative z-0">
            ...
            <Link
              href="/about-us"
              className="inline-flex items-center gap-2 text-peter hover:text-peter-dark font-semibold transition-colors relative z-0"
            >
              {t("buttonText")}
          ...
          {/* Right Side - Image */}
          <div className="flex justify-center md:justify-end items-center relative z-0">
