                    ...
                    rules={{
                      ...
                      validate: (value) =>
                        !value
                          ...
                          tOtherBusinesses("form.phoneNumberInvalid"),
                    }}
                    render={({ field }) => (
                      <PhoneInput
                        id="phoneNumber"
                        ...
                        onBlur={field.onBlur}
                        className={cn(
                          "PhoneInput mt-1 flex h-10 w-full min-w-0 rounded-md border pl-2 pr-0 shadow-xs transition-[color,box-shadow] outline-none",
