      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-gray-600 text-base md:text-lg max-w-3xl mx-auto leading-relaxed">
            Lorem ipsum dolor sit amet consectetur. Gravida aliquam euismod vel
            libero mattis pulvinar vitae nisi cursus. Vitae sem imperdiet amet
            aliquet. Iaculis accumsan malesuada aliquam duis.
          </p>
        </div>
