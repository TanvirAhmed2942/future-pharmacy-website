...
export default function PaymentsDetails() {
  return (
    <div className="w-full space-y-7">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-8 gap-6">
        ...
        <Card className="border col-span-6 border-gray-200">
        ...
        <Card className="border col-span-2  w-full border-gray-200">
          <CardContent className="px-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-6">Download / Actions</h2>
            ...
            <div className="space-y-3">
              ...
              <Button 
                className="w-full justify-center h-11 bg-peter hover:bg-peter/90 text-white"
              >
                Contact Support
              </Button>
            </div>
 ...
 <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
     {/* Left Column Bottom - Prescription / Request linked */}
        <Card className="border col-span-3 border-gray-200">
          <CardContent className="px-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-6">Prescription / Request linked</h2>
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <p className="text-base text-gray-900">1901 Thornridge Cir. Shiloh, Hawaii 81063</p>
              </div>
              ...
              <div className="bg-gray-100 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div>
                    ...
                    <span className="text-gray-900">sara.johnson@gmail.com</span>
                  </div>
                  <div>
                    <span className="text-gray-500">Billing Address: </span>
                    <span className="text-gray-900">1901 Thornridge Cir. Shiloh, Hawaii 81063</span>
                  </div>
                </div>
              </div>
            </div>
